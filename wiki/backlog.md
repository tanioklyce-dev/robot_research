...
- [ ] **Molmo entity** (Allen Institute for AI open VLM) — the backbone under [MolmoAct](entities/molmoact.md); no page yet. File if it recurs or when MolmoAct's primary is ingested.
