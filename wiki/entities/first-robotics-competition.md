...
## Scale & reach
- ~3,700 teams across 30+ countries; ~90,000 students in 2026 ([[frc-2026-game-manual|FRC 2026 Game Manual]], §1.3).
...
- **Match structure**: 2:40 matches — 20s autonomous + 2:20 teleoperated. 3v3 alliance format ([[frc-2026-game-manual|FRC 2026 Game Manual]], §6).
...
## 2026 game: REBUILT
- Presented by the Gene Haas Foundation ([[frc-2026-game-manual|FRC 2026 Game Manual]]).
...
- See [[frc-2026-game-manual|FRC 2026 Game Manual]] for full details.

## Robot constraints (2026)
- Weight: ≤115lb (without bumpers/battery); ≤135lb with bumpers ([[frc-2026-game-manual|FRC 2026 Game Manual]], R103/R408).
- Starting configuration: ≤110in perimeter, ≤30in tall.
- Extension: ≤12in beyond perimeter, one direction at a time.
- Mandatory control system: [[roborio|roboRIO]] + FRC Radio + FMS Ethernet.
...
- **[[apriltags|AprilTags]]**: 32 fiducial markers (36h11 family) on field elements enable autonomous vision-based navigation and targeting ([[frc-2026-game-manual|FRC 2026 Game Manual]], §5.11).
...
- [[andymark|AndyMark]]: Field elements, AM14U6 chassis (KitBot), FUEL, bumper materials.
...
- **NI (National Instruments)**: [[roborio|roboRIO]] controller.
- **Limelight / PhotonVision**: Popular vision processing solutions for AprilTag detection.

## Culture
- **Gracious Professionalism**: Ethos of high-quality work while valuing others; coined by Dr. Woodie Flowers (1943–2019) ([[frc-2026-game-manual|FRC 2026 Game Manual]], §1.4.2).
