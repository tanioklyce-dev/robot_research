...
- **TRI LBM (Large Behavior Model)** — generalist robot policy; referenced in [RoboCasa365 Paper](../sources/robocasa365-paper.md) as a baseline. Primary source not yet ingested.
- **Drake** — TRI/MIT open-source robot simulation and dynamics library (Russ Tedrake's group). On the wiki TBD list.
...
- **Russ Tedrake's TRI VP role** intersects MIT robot-locomotion research (Drake, model-based control) with TRI's data-driven robotics line. Worth tracking when MIT-Drake or model-based-control work surfaces.
...
- **TRI LBM primary source** — not yet ingested. The closest counterpart to GR00T / π0 in the wiki's VLA landscape; high-value future ingest.
- **Drake** library (Tedrake) — TBD entity page. Currently on wiki TBD list.
- **Russ Tedrake** — entity page on demand; senior figure across TRI publications + MIT robot-locomotion line.
