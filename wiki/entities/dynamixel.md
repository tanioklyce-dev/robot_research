...
| Typical kit cost (LeRobot platforms) | [Koch-v1.1](koch-v1-1.md) ~€670 (single) | SO-100/101 ~€225 (single) |
...
- [Koch v1.1](koch-v1-1.md) — the Dynamixel-based LeRobot reference arm.
- [Rhoban](rhoban.md) — authors of **BAM**, the actuator-identification framework whose M6 model of the XL330 underpins [Microduck](microduck.md)'s sim-to-real.
...
- ~~**Koch-v1.1 deserves its own entity page**~~ — **filed** as [Koch v1.1](koch-v1-1.md) (2026-08-27), with the repo's own BOM confirming the ~€670 figure is the **leader+follower pair**. Note the repo has been dormant since **September 2024**.
