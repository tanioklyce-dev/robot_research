...
Stanford roboticist and control theorist — Departments of **Mechanical Engineering** and **Aeronautics & Astronautics**, Stanford University; leads the **Autonomous Systems Lab (ASL)**. Co-author on four ingested sources, all on the same side of the field: **the control-theoretic layer underneath learned behavior**.
