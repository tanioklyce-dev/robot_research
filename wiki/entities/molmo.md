...
- **Molmo-7B-O** — **OLMo-7B** backbone (the fully-open one).
...
- **OLMo / OLMoE** — the open LLMs behind Molmo's "100% open" claim — still have no wiki entity or source; the OLMo papers are the obvious next ingest.
