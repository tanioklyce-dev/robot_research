...
- [OmniVLA paper](../sources/omnivla-paper.md) — OpenVLA-7B as the base of a **navigation** VLA (LoRA ~5%, goal-image + pose projectors, modality dropout); the 7B model beats a 50M ViNT-style edge model only on out-of-distribution language.
