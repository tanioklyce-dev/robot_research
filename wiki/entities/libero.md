...
>
> **2. The top of the table is a statistical tie.** Per the [success-rate audit](../syntheses/platforms/vla-success-rate-audit.md): at the confirmed protocol (**50 episodes/task → 500/suite, 2,000 for a four-suite average**), separating two policies at ~97% requires a gap of **>1.8 pp** (or >1.0 pp on the average). **MolmoAct2 97.2, MolmoAct2-Think 98.1, [X-VLA](x-vla.md) 98.1, [TurboVLA](turbovla.md) 97.7, CogVLA 97.4, VLA-Adapter 97.3, [VLA-JEPA](vla-jepa.md) 97.2, OpenVLA-OFT 97.1, GR00T N1.7 97.0, and π0.5 96.9 are not distinguishable from one another** (all pairwise p > 0.1 except Think-vs-base at p=0.06). Same for the VLA-0 94.7 / π0.5-KI 94.3 / π0 94.2 cluster. **The tied cluster is now ten models wide and spans 1.2 pp.**
>
