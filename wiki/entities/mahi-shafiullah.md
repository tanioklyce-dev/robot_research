...
The **dual NYU + Hello Robot affiliation** is structurally interesting: one foot in academic research, the other inside the robot vendor. The combination is what enables RUM's unusually-tight integration between data-collection rig design (Stick-v2), policy training (NYU compute), and deployment hardware (Stretch from Hello Robot). Few research groups have this configuration.
