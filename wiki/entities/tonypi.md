...
updated: 2026-05-08
sources: 0
tags: [tonypi, hiwonder, humanoid, bipedal, education, raspberry-pi, biped-kit]
status: stub
---

**TonyPi / TonyPi Pro** — small bipedal humanoid education kits from [Hiwonder](hiwonder.md). Same vendor as [ROSOrin](rosorin.md) and [ROSOrin Pro](rosorin-pro.md). Targets the **educational-tier humanoid** niche at price points well below NAO ($300–$700 vs NAO's $8k+).

## Specs (TonyPi Pro, 2024 generation)
- ~17 DOF (typical biped kit configuration).
- Raspberry Pi 4 / Raspberry Pi 5 controller.
- Cameras + IMU; HX-12H bus servos (same servo line used in [ROSOrin Pro](rosorin-pro.md)).
- Pre-loaded software for walking, vision, and basic AI demos.
...
- **Smallest + cheapest** humanoid in this wiki.
- **Same vendor as [ROSOrin Pro](rosorin-pro.md)** — likely shares HX-12H bus servos, similar Hiwonder software stack, similar educational positioning.
- **Far below research-tier capability** — limited payload, no dexterous manipulation, walking is basic.
