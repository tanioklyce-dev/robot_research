...
- **TurtleBot 4** (2022, Clearpath/iRobot) — [iRobot Create 3](irobot-create-3.md) base + Raspberry Pi 4B + RPLIDAR + OAK-D camera. ROS 2-native.
...
## Mentioned in
- *(no source pages directly cite TurtleBot yet; referenced in [index.md](../index.md) gaps as a comparison point for ROSOrin)*
