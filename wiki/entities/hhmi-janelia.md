...
**HHMI Janelia Research Campus** — Howard Hughes Medical Institute's pure-research lab in Ashburn, VA. Long-running anchor of *Drosophila* neuroscience and connectomics. Home of the **Turaga Lab** that led [flybody](flybody.md), and a major contributor of *Drosophila* behavioural-tracking and connectomics tooling cited throughout the flybody paper.

## Relevant groups (per [flybody Paper](../sources/flybody-paper.md))

- **Turaga lab** (Srinivas C. Turaga) — corresponding author on flybody.
- **Branson lab** (Kristin M. Branson) — APT animal-part-tracker; Fly Disco behavioural rig.
- **Reiser lab** (Michael B. Reiser) — fly visual neuroscience.
