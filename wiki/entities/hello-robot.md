...
## What we know
- **Hardware**: [Stretch](stretch.md). **Current generation: Stretch 4** (launched 2026-05-12, **$29,950 base**; +$2,495 for optional Jetson Orin NX AI accelerator) — see [Stretch 4 launch source](../sources/hello-robot-stretch-4-launch.md). Major upgrades over Stretch 3: new omnidirectional holonomic base, dual hemispherical 3D LiDAR, 3DOF cobot-style ambidextrous wrist with integrated Luxonis OAK-SR depth, 8 redundant DOF + gripper, ~2× faster motion, 10% more reach, 8 hr runtime with self-charging dock.
...
## Mentioned in
- [Stretch 4 launch — Hello Robot purchase + product + forum announcement](../sources/hello-robot-stretch-4-launch.md) — Stretch 4 canonical reference (2026-05-12).
