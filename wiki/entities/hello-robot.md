...
## What we know
- **Hardware**: [Stretch](stretch.md) (current generation: Stretch 3) — arm + mobile base + gripper + RealSense cameras + LiDAR.
...
- **Adoption signal**: [Robot Utility Models](robot-utility-models.md) (NYU/Meta) chose Stretch as the primary platform for zero-shot generalist policies; Aaron Edsinger (Hello Robot co-founder, ex-MIT/Meka Robotics) is a co-author on the RUM paper ([Robot Utility Models Project Page](../sources/robot-utility-models-website.md)).
