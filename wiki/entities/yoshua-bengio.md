...
- **Cho et al. 2014a** (the GRU / RNN Encoder–Decoder paper, from the same Montréal group) remains un-ingested; the wiki's glossary defines the GRU without a primary.
