...
updated: 2026-07-25
sources: 7
tags: [ai2, allen-institute, research-lab, open-source, open-data, seattle, nonprofit, robotics, vla]
---
...
recipes, checkpoints, and logs**. It is the single lab behind the wiki's entire
"open-everything" thread.
...
- **Recipes/tools (referenced):** Tülu 3 post-training + **RLVR**, the OLMES eval
  suite, Open Instruct — the surrounding open toolchain.
...
- [MolmoAct](molmoact.md) / [MolmoAct2](molmoact2.md) — Ai2's open action-reasoning VLAs.
