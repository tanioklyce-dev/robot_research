...
- **[SAC: Algorithms and Applications](../sources/sac-applications-paper.md)** (Haarnoja, …, Gupta, Abbeel, Levine — 2018) — senior author. The practical SAC (automatic temperature α) + first real-robot SAC demos (Minitaur, dexterous hand).
...
- [SAC Applications paper](../sources/sac-applications-paper.md) — senior author.
