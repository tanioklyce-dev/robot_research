...
- **With vision added** ([egocentric-vision locomotion](../sources/egocentric-vision-locomotion-paper.md)): a front-facing **Intel RealSense** in the head, onboard **UPboard + [Jetson Xavier NX](jetson-xavier-nx.md)**, policy at **50 Hz** over a PD loop at **400 Hz**. Depth arrives at 480×848 every **100 ± 20 ms**, downsampled to **58×87**, crossing a UDP socket with **10 ± 10 ms** latency the policy is trained against.
