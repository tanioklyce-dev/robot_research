...
- **A misattributed citation.** The S1 post cites [FACTR 2](../sources/factr-2-paper.md) (Pathak is its last author) for the claim that from-scratch policies with dense post-training data match post-trained foundation models; the paper makes no such comparison. Small, but it is the company's own CEO's paper, cited for something it does not say.
