...
## Related
- [LLM-agent architecture](llm-agent-architecture.md) — CoT is the typical reasoning style of the LLM planner emitting tool calls.
- [VLA models](vla-models.md) — embodied CoT bakes reasoning into the action policy.
- [AI safety and alignment](ai-safety-alignment.md) — chain-of-thought monitoring as a (debated) interpretability tool.
