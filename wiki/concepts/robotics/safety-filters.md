...
- **Perception.** All three consume a hazard geometry they do not produce: keep-out boxes, sphere decompositions, or object poses with bounded measurement error. In an unstructured home the hazards are the things nobody modelled, and **this is the single shared blocker**.
