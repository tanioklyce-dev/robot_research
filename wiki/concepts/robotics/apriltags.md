...
## Related concepts
- [Sim-to-real transfer](../learning/sim-to-real-transfer.md) — simulated AprilTags used to train vision pipelines before deployment
- [World model](../world-models/world-model.md) — AprilTag-based localization provides state estimates that world models could condition on
