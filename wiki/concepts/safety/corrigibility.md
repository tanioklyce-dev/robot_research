...
- [LLM-agent architecture](../agents/llm-agent-architecture.md) — the architecture where corrigibility properties play out in real-world deployments.
