...
- **Substitutes for simulators in some pipelines.** If the world model is good enough, you don't need a hand-built simulator — see [world-model-simulators concept](world-model-simulators.md) and [the paradigm comparison](../syntheses/generative-video-vs-jepa-world-models.md).
...
- [Generative-video vs JEPA world models](../syntheses/generative-video-vs-jepa-world-models.md) — synthesis comparing two major design points.
