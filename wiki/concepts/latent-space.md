...
### Implicit / supporting
- **[Diffusion Policy](../entities/diffusion-policy.md)**, **[VLA models](vla-models.md)**, and most modern policies operate over learned visual + language embeddings rather than raw pixels.
...
- [Generative-video vs JEPA world models](../syntheses/generative-video-vs-jepa-world-models.md) — synthesis comparing pixel-space vs latent-space prediction targets.
