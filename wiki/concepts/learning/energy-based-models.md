...
The wiki has three quite-different EBM applications, all downstream of [Yann LeCun](../../entities/yann-lecun.md)'s long-running advocacy of energy-based learning as an alternative to maximum-likelihood / autoregressive training:
