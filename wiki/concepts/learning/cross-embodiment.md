...
- [GA-VLN](../../sources/ga-vln-paper.md) — the MLLM-VLN interface is four discrete actions (forward 0.25 m, turn 15°, stop); moved from Habitat to a Stretch 3 by changing the turn step and BEV update rate.
