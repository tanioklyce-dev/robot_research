...
|---|---|---|---|
| **[RLPD](../../sources/rlpd-paper.md)** (2023) | the off-policy engine (symmetric sampling + LayerNorm + ensembles) | — (sim benchmarks) | ~2.5× over prior offline-to-online |
...
- **[RLPD paper](../../sources/rlpd-paper.md)** (Ball, Smith, Kostrikov, Levine — ICML 2023) — the base off-policy algorithm; symmetric sampling + LayerNorm + ensembles.
