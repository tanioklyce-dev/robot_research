...
- [SO-ARM101](entities/so-arm101.md) — open-source low-cost arm (The Robot Studio); SO-ARM100 successor; default LeRobot manipulator; SO-10X drives 50%+ of community-contributed LeRobotDatasets as of Sep 2025; Rosetta ships `so_101.yaml` + `so_101_hil.yaml` as the reference manipulator contracts. (7 sources)
...
- [LeRobot](entities/lerobot.md) — Hugging Face's open-source **end-to-end robot learning library** ([ICLR 2026](sources/lerobot-iclr-2026-paper.md)); 8 platforms; 16K+ datasets / 2.2K+ contributors (Sep 2025); async producer-consumer inference; reference RL + BC + VLA implementations; 916-team Worldwide Hackathon in June 2025. (10 sources)
- [Rosetta](entities/rosetta.md) — solo-author Apache-2.0 bridge from [LeRobot](entities/lerobot.md) to ROS 2 (76 stars, Sep 2025); YAML-contract-driven topic-to-LeRobot-feature mapping; ships SO-101 + TurtleBot3 reference contracts + experimental HIL support; extends supported policies with π0.5, GR00T, Wall-X, X-VLA. Resolves the "FeeTech/Dynamixel-only middleware" limitation for any ROS 2-controllable robot. (1 source)
