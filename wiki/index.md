...
- [Chain of thought](concepts/chain-of-thought.md) — intermediate-reasoning-token technique; origin (Wei 2022); zero-shot/self-consistency/ToT; modern reasoning models; embodied CoT in VLAs and S1/S2 splits. (0 sources — hub page)
...
- [ROSOrin Pro — Lego pick-and-place project plan](syntheses/rosorin-pro-lego-pick-place.md) — the BC-path sibling to the JEPA ladder; three tiers (OpenClaw color-threshold → LeRobot ACT/DP behavior cloning → GR00T fine-tune); recommends Tier 2 for "robust enough to use." (2026-05-15)
