...
- [End-user robot programming](concepts/end-user-robot-programming.md) — enabling non-experts to customize robot behavior; EUP approaches; sense of agency evidence; Stretch SE2 transfer. (4 sources)
...
- [Robot-learning curriculum — from neurons to LeWorldModel](syntheses/robot-learning-curriculum.md) — 14-module curriculum hub (outline; module pages drafted on signal — Modules 6, 7, 10, 11 first). (2026-05-10)
