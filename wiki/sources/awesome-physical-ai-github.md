...
- **Model-based-RL world-model line** — ~~mostly absent~~ *closed 2026-07-09: DreamerV3/TD-MPC/TD-MPC2 were already ingested; since added — [S5WM](s5wm-paper.md), [EAWM](eawm-paper.md), [World Models](world-models-paper.md), [PlaNet](planet-paper.md), [MuZero](muzero-paper.md), [EfficientZero](efficientzero-paper.md), [DayDreamer](daydreamer-paper.md), [DIAMOND](diamond-paper.md).* Still missing: Genie 2, GAIA-1, UniSim (playable/AV frontier).
- ~~**Locomotion corpus**~~ — **substantially closed 2026-08-29.** Was: RMA, legged_gym/RSL-RL, ANYmal Parkour, HumanPlus/OmniH2O/H2O/ASAP/HOVER, Walk These Ways, against a wiki that tracked locomotion only via GR00T-adjacent whole-body work ([SONIC](../entities/gear-sonic.md)).
  - **Now ingested**: [RMA](rma-paper.md) (RSS 2021), the [egocentric-vision follow-up](egocentric-vision-locomotion-paper.md) (CoRL 2022), [LocoFormer](locoformer-paper.md) (CoRL 2025) — the whole CMU/Berkeley→Skild arc.
  - **Tooling filed**: [legged_gym](../entities/legged-gym.md), [Isaac Gym](../entities/isaac-gym.md), [Unitree A1](../entities/unitree-a1.md), [Jetson Xavier NX](../entities/jetson-xavier-nx.md).
  - **Still open**: the **humanoid** half (HumanPlus / OmniH2O / H2O / ASAP / HOVER), ANYmal Parkour, Walk These Ways, and the Rudin et al. legged_gym primary. **This is the one gap-mining hit that has paid off most**, which is the argument for re-reading the list's taxonomy periodically.
