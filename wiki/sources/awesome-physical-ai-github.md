...
- **Model-based-RL world-model line** — ~~mostly absent~~ *correction 2026-07-09: [DreamerV3](../sources/dreamer-v3-paper.md), [TD-MPC](../sources/td-mpc-paper.md), and [TD-MPC2](../sources/td-mpc2-paper.md) were already ingested; [S5WM](s5wm-paper.md) + [EAWM](eawm-paper.md) added since.* Still missing: **DayDreamer** (real-robot Dreamer), PlaNet/MuZero (lineage), Genie 2, GAIA-1, UniSim.
