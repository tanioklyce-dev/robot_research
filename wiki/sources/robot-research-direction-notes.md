...
| Stay safe | [semantic safety](../concepts/safety/semantic-safety.md), [safety filters](../concepts/robotics/safety-filters.md), [safety certificates](../concepts/robotics/safety-certificates.md) | medium; enforcement exists only for the physical half |
