...
- **DreamGen / DreamZero / DreamDojo (2025–2026)** — the GEAR world-model triplet; would substantially deepen the wiki's [world-model](../concepts/world-models/world-model.md) and [world-model-simulators](../concepts/world-models/world-model-simulators.md) coverage and provide a clean NVIDIA-side counterpoint to the FAIR JEPA program.
