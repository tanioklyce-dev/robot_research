...
- **Neural trajectories:** WAN2.1-I2V-14B fine-tuned via LoRA on the 88 h of teleop (3,000 language-annotated samples), generating **827 h ≈ 300k trajectories — a ~10× multiplication of the real data** — with counterfactual prompts; a multimodal LLM does prompt generation, filtering-as-judge, and re-captioning. Cost: ~**105k L40 GPU-hours** (3,600 L40s, ~1.5 days).
