...
- **BEHAVIOR-1K** (real household environments): 2025 Challenge top team (Robot Learning Collective) Q-score 26%; **full task success rate only 12.4%**. "Reliably executing household tasks in realistic environments is still beyond current capabilities."
