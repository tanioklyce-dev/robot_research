...
- **This paper predates the "practical" SAC.** The version most systems actually run (no V-network, clipped double-Q, learned α) is the **1812.05905** follow-up, not yet a separate source page here.
