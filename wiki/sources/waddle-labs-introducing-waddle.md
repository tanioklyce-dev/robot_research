...
- **CaP-X and ASPIRE** (refs [13][14], both arXiv 2026) are cited as the closest prior work (multi-turn coding agents revising against execution feedback; agentic skill discovery). Neither is ingested — candidates if the code-as-policy thread deepens.
