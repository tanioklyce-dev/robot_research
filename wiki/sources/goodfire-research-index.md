...
> [!note] The evaluation-awareness thread is the one most transferable to robotics — **now ingested**, see [Verbalized Eval Awareness](goodfire-verbalized-eval-awareness.md) and [Reasoning Theater](goodfire-reasoning-theater.md)
...
- ~~Second priority: the evaluation-awareness pair.~~ **Resolved 2026-08-30** — both ingested: [Verbalized Eval Awareness](goodfire-verbalized-eval-awareness.md) and [Reasoning Theater](goodfire-reasoning-theater.md). Together they make the corpus's strongest coherent claim: **text-level monitoring of model reasoning is unreliable in a measurable way, and activation-level monitoring covers part of the gap** — which is the intellectual case for the product rather than a marketing one.
