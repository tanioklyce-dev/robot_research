...
- **Is WowRobo's OpenArm 1.0 the same lineage as Sensori's OpenArm+?** Unresolved, and it bears on whether an open arm standard is actually consolidating. **Resolved 2026-09-13**: yes — both are [Enactic's OpenArm](../sources/openarm-docs.md); WowRobo is the certified manufacturer, Sensori's OpenArm+ a derivative.
