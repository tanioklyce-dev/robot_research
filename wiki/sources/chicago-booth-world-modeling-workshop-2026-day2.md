...
- ~~**Day 3 is not ingested.**~~ **Resolved 2026-09-03** — auto-captions appeared on the VOD, as with Day 2. [Day 3](chicago-booth-world-modeling-workshop-2026-day3.md) is the hands-on day: Balestriero teaching the LeJEPA/SIGReg/LeWM line from his own code, Bradford Levy on financial-data augmentation, a simulation **cost model** from Lambda, a hackathon, and Ethayarajh's three-era history of the term "world model."
