...
- **Cross-embodiment transfer**: trained on [Stretch](../entities/stretch.md), deployed zero-shot on xArm 7 with no further data, training, or fine-tuning.
