...
1. **Price.** $20k for Stretch 3 ([IEEE Spectrum](../../sources/ieee-spectrum-stretch-assistive.md)). Within an academic lab's discretionary equipment budget. ~17× cheaper than [educational tier](../platforms/robot-platforms-comparison.md) on the relevant axis vs PR2.
...
| **Cheap educational JEPA experiments** | [ROSOrin Pro](../../entities/rosorin-pro.md) ([feasibility analysis](../projects/lewm-on-rosorin-pro-feasibility.md)). Limits are real but acceptable for pedagogy.
| **JEPA on a real research-grade robot** | Stretch + RUM dataset ([LeWM-on-Stretch feasibility](../projects/lewm-on-stretch-feasibility.md)). |
...
- [Robot platforms — comparison](../platforms/robot-platforms-comparison.md) — at-a-glance comparison of every platform in the wiki.
- [Household robot decision — Stretch vs Unitree G1](../platforms/household-robot-decision-stretch-vs-g1.md) — adjacent buying-decision context.
- [LeWM on Stretch — feasibility analysis](../projects/lewm-on-stretch-feasibility.md) — Stretch as a research substrate for JEPA work.
- [DINO-WM on Stretch — concrete experiment plan](../projects/dino-wm-on-stretch-experiment.md) — concrete next-experiment plan on this platform.
