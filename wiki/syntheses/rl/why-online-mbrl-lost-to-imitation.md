...
- **And RL itself returned — but offline, on top of imitation**: [π*0.6's RECAP](../../sources/pistar06-paper.md) (offline RL pretraining + advantage-conditioned improvement from deployment data + human interventions) is 2025–26's "learning from experience," with the exploration problem tamed by an IL foundation and human gates. That is the synthesis position: **not** imitation *versus* RL, but RL as post