...
### Comparison (recapping the table from [`concepts/vla-models.md`](../concepts/vla-models.md))
...
- **Gemini Robotics-ER** ("ER" = embodied reasoning) — a *VLM* that emits **tool calls** rather than low-level actions. Pairs with classical robot SDKs. Architecturally an [LLM-agent system](../concepts/llm-agent-architecture.md), not strictly a VLA.
...
These exist in the curriculum's peripheral vision; check [`concepts/vla-models.md`](../concepts/vla-models.md) for the live list.
...
1. **[`concepts/vla-models.md`](../concepts/vla-models.md)** — concept page; re-read the action-head comparison table.
...
These are siblings. They cross over at [VLA-JEPA](../entities/vla-jepa.md) (auxiliary JEPA loss inside a VLA — covered above) and at the **frozen-vision-encoder** axis (DINOv2 / SigLIP work in both lineages — see [`concepts/jepa.md`](../concepts/jepa.md) and [`concepts/vla-models.md`](../concepts/vla-models.md)).
