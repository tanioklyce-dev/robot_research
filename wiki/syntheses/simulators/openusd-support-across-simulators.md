...
CES 2026 launch. Built on top of Isaac Sim / Omniverse, so USD support is inherited rather than independent. Adds LLM-driven scene generation and a 100k-scenario evaluation suite for [VLA models](../../concepts/learning/vla-models.md) ([CES 2026 announcement](../../sources/agibot-genie-sim-3-announcement.md)).
...
- [Why JEPA research skips the simulator stack](../world-models/why-jepa-research-skips-the-simulator-stack.md) — companion synthesis filed at the same time.
