...
- **Vendor-neutral substrate, vendor-specific framework.** The interesting ML differentiation moves *up the stack* — to environment APIs, learning frameworks ([Isaac Lab](../../entities/nvidia-isaac-lab.md) vs Playground vs ManiSkill), and model libraries ([GR00T](../../entities/nvidia-groot.md), [VLAs](../../concepts/learning/vla-models.md)). The physics layer becomes commoditized infrastructure, like LLVM for compilers or Linux for OSes.
