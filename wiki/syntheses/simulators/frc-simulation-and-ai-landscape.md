...
These tools produce **open-loop** trajectories. The robot uses odometry + [AprilTag](../../concepts/robotics/apriltags.md) pose estimation (via PhotonVision or Limelight) to correct drift, but the path itself is pre-planned, not learned.
