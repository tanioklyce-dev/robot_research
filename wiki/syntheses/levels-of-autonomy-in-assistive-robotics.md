...
| **Programming autonomy** | Who specifies the *behavior*? Engineer ↔ third-party operator ↔ end user (EUP). | [Yang et al. 2025](../sources/yang2025-sense-of-agency.md); [End-user robot programming](../concepts/end-user-robot-programming.md). |
...
- [End-user robot programming concept](../concepts/end-user-robot-programming.md)
...
- [End-user robot programming](../concepts/end-user-robot-programming.md) — the practical design lever this synthesis recommends.
- [Assistive robotics](../concepts/assistive-robotics.md) — concept overview.
- [LLM-agent architecture](../concepts/llm-agent-architecture.md) — the layer between user-authored programs and low-level skills.
