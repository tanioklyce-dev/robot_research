...
- **[JEPA](../concepts/jepa.md)** — predict the next-state *embedding*, not pixels. Module 11's family.
...
**Cost:** stuck with the pretrained encoder's representational choices. If DINOv2 wasn't trained on your task distribution, its features may not be optimal. [LeWM vs DINO-WM](../syntheses/curriculum-12-lewm-deep-dive.md) is exactly this trade-off.
