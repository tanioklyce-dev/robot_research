...
> Asked about humanoids in the [MIT Technology Review launch interview](../../sources/mit-tech-review-lecun-ami-labs-interview.md) (2026-01-22): *"nobody — absolutely nobody — knows how to make those robots smart enough to be useful,"* and *"if we want a generally useful domestic robot… that's not going to happen until we have good world models and planning."* He names the bar — *"a domestic robot that is as agile as a house cat"* — and gives **no year**. The dates he does give elsewhere are for the architecture (3–5 years) and for an industrial-first company plan that excludes robots. The nearest thing to a robot timeframe is [Davos 2025](../../sources/wef-davos-2025-debating-technology.md), under a slide headed *"consumer robotics"*: *"maybe the coming decade will be the decade of robotics, **because maybe** we'll have AI systems that are sufficiently smart to understand how the real world works"* — a decade, conditional on the 3–5-year breakthrough, with two hedges.
>
> The fullest version, from [AI House the same week](../../sources/ai-house-davos-2026-lecun-embodied-ai.md), adds the standard this page should be measured against — *"ask a 10-year-old to clear the dinner table and fill up the dishwasher. A 10-year-old can do it the first time"* — and names what a robot's world model must contain: a mechanical model of the robot, a model of the environment's physics, and a model of their interaction. Only the first is *"writable with a bunch of equations."* His clock is on the other two: *"the challenge for the next few years."*
>
> **And it is not only LeCun's shape.** [Hassabis at Davos 2026](../../sources/wef-davos-2026-the-day-after-agi.md), from the opposite architectural camp: world models and continual learning are *"the things that will need to be cracked… and then I think things like robotics may have its breakout moment."* Physical AI sits inside his AGI definition as the hardware-bound, slow-to-verify part. Amodei, who gives the room's most aggressive dates, does not mention robots. Three leaders, and robotics is downstream of a breakthrough in every account that includes it. So the architect of the program and this page agree on the form of the answer, and neither supplies the number.
