...
- [Sim-heavy vs real-data paths to generalist policies](../simulators/sim-heavy-vs-real-data-paths.md) — companion synthesis showing where the rest of the field sits.

## Related

- [Joint-Embedding Predictive Architecture](../../concepts/world-models/jepa.md) — the architecture family.
- [World-model simulators](../../concepts/world-models/world-model-simulators.md) — broader paradigm context.
- [OpenUSD support across simulators](../simulators/openusd-support-across-simulators.md) — companion catalog.
