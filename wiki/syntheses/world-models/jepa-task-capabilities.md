...
- **Mechanism** — a next-frame objective is *paid* to encode static attributes, and no JEPA world-model recipe in the wiki declares any input axis irrelevant ([abstraction tax](abstraction-tax.md); LeWM verified to use **no augmentation at all**).
