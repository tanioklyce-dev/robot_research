...
Three of these four have an **industrial strategic** as an anchor rather than a pure financial investor — Brookfield (real estate, and the data that comes with it), Mercedes-Benz (factory), Toyota (factory and former parent). The exception, XPeng, is itself the industrial strategic.
...
- **Coverage gap surfaced by writing this.** **Skild AI** is a significant model-layer player and has no entity page — it appears only in passing mentions. Same for most of the Chinese automaker robotics units (AiMOGA, Huilun, BYD's programme), which are named here from trade press and nowhere else in the wiki.
