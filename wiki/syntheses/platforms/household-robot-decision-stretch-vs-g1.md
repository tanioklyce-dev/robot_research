...
- [LeWM on ROSOrin Pro — feasibility analysis](../projects/lewm-on-rosorin-pro-feasibility.md) — adjacent decision document for an educational-tier alternative.
...
- [Sim-heavy vs real-data paths to generalist policies](../simulators/sim-heavy-vs-real-data-paths.md) — relevant context for "where the data comes from."
