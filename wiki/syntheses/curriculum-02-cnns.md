...
1. **Get the data.** Clone the [diffusion_policy](https://github.com/columbia-ai-robotics/diffusion_policy) repo or use the `stable-worldmodel` PushT dataset from [LeWM howto](leworldmodel-howto.md). Extract ~500 frames at 96×96 resolution.
