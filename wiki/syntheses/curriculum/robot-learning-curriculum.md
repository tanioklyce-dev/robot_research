...
status: "complete — drafted 2026-05-10; Modules 9 and 13 refreshed 2026-08-03; other modules carry a May-2026 as-of note."
---

> [!warning] As-of note (added 2026-08-03) — this curriculum reflects the May-2026 state of the field
> The pedagogy (Tiers 1–2, the PushT thread, the JEPA/LeWM arc) ages well. The **survey content does not**: since drafting, the wiki ingested the [success-rate audit](../platforms/vla-success-rate-audit.md) (the top of the LIBERO table is a statistical tie), the [LIBERO-PRO critique](../../sources/libero-pro-paper.md) (>90% scores collapsing to 0.0% under perturbation — the benchmark may measure memorization), [MolmoAct2](../../entities/molmoact2.md), the [Gemini Robotics 2 generation](../../entities/gemini-robotics.md), and the full [code-as-policy lineage](../../concepts/agents/code-as-policy.md). **Modules 9 (VLA) and 13 (deployment) were refreshed 2026-08-03** — Module 9 gained the hybrid action-head flavor, MolmoAct2/GR 2 coverage, and a "how to read a VLA results table" section; Module 13 gained "The 2026 deployment stack." Other modules still reflect May 2026; read benchmark numbers against the audit before repeating them.
...
> [!note] Rigorous mathematical companion — "The Elements of Differentiable Programming"
> **[The Elements of Differentiable Programming](../../sources/blondel-roulet-differentiable-programming.md)** (Blondel & Roulet, Google DeepMind, draft v3 June 2025; 485 pages, free on arXiv) is the **most comprehensive single reference** for the math underlying everything in this curriculum: autodiff (the rigorous version of Module 1 backprop), transformers (Module 3), generative models + reparametrization trick + flow matching (Module 5), REINFORCE / score function estimator (Module 8), softmax / sparsemax / Fenchel-Young losses (cross-cutting). Use it as the **lookup reference** when a curriculum module hand-waves through a derivation. Pairs especially well with Tier 1 (Modules 1–4) and the BC/RL math in Tier 3 (Modules 6–8).
...
- **Concept beats:** representation learning, contrastive learning ([SimCLR](../../glossary.md#simclr) / [MoCo (momentum contrast)](../../glossary.md#moco)) vs predictive ([MAE (masked autoencoder)](../../glossary.md#mae) / [JEPA](../../glossary.md#jepa)), the [latent space](../../concepts/world-models/latent-space.md) as object, **representation collapse** as a failure mode, anti-collapse families: [EMA (exponential moving average)](../../glossary.md#ema) target encoders + stop-gradient ([BYOL — bootstrap your own latent](../../glossary.md#byol) / [DINO](../../glossary.md#dino)), variance / covariance regularization ([VICReg](../../glossary.md#vicreg), [Barlow Twins](../../glossary.md#barlow-twins)), normality-based (LeWM's [SIGReg](../../glossary.md#sigreg)).
...
- **Concept beats:** [world model](../../concepts/world-models/world-model.md) functional definition; the four families (generative-video / [WFM (world foundation model)](../../glossary.md#wfm), [JEPA](../../glossary.md#jepa) / latent-prediction, frozen-foundation-feature, [Dreamer](../../glossary.md#dreamer--dreamerv3)-style reward-conditioned); [MPC](../../glossary.md#mpc) vs [CEM (cross-entropy method)](../../glossary.md#cem) vs gradient-based planning; planning horizon and compounding error; the [generative-video vs JEPA](../world-models/generative-video-vs-jepa-world-models.md) tradeoff.
...
- **Concept beats:** what "joint embedding" means (per [JEPA concept page](../../concepts/world-models/jepa.md)); V-JEPA 1 → [V-JEPA 2](../../entities/v-jepa-2.md) → V-JEPA 2-[AC (action-conditioned)](../../glossary.md#ar) → V-JEPA 2.1 progression; [DINO-WM](../../entities/dino-wm.md) (frozen-encoder JEPA-adjacent) vs end-to-end JEPA ([LeWM](../../glossary.md#lewm), [PLDM](../../glossary.md#pldm)); [JEPA-WMs](../../glossary.md#jepa-wms) on real Franka; action conditioning; the collapse problem revisited.
...
- **Anchor exercise:** install [LeWM](../../sources/lewm-github.md) per [the howto](../world-models/leworldmodel-howto.md); reproduce a single PushT eval at a pretrained checkpoint. Then derive SIGReg's gradient-through-projection on paper.
...
- **Anchor exercise:** read [DINO-WM on Stretch experiment plan](../projects/dino-wm-on-stretch-experiment.md) and [LeWM on Stretch feasibility](../projects/lewm-on-stretch-feasibility.md); state the one experiment most worth running.
...
- **Phase A (paper / sim — required):** reproduce LeWM PushT from scratch ([detailed scope already filed](../projects/lewm-hello-world-project-scope.md)); install / train / eval per [the howto](../world-models/leworldmodel-howto.md); produce a written experiment-design memo for the smallest credible LeWM-on-Stretch or DINO-WM-on-Stretch experiment ([feasibility analysis](../projects/lewm-on-stretch-feasibility.md), [DINO-WM-on-Stretch plan](../projects/dino-wm-on-stretch-experiment.md)).
...
| 4 SSL & embeddings               | partial in [latent-space](../../concepts/world-models/latent-space.md), [JEPA](../../concepts/world-models/jepa.md)                                                                                                                                                                      | **drafted** — [Curriculum Module 4 — Self-supervised learning and embeddings](curriculum-04-self-supervised-learning.md) |
...
| 6 Imitation learning             | [concept](../../concepts/learning/imitation-learning.md), [PushT entity](../../entities/pusht.md)                                                                                                                                                                       | **drafted** — [Curriculum Module 6 — Imitation learning and behavior cloning](curriculum-06-imitation-learning.md) |
