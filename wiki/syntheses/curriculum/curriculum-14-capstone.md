...
**Existing artifact:** [LeWM hello world — Project 1 detailed scope](../projects/lewm-hello-world-project-scope.md). Phase-by-phase plan:
- Install [`stable-worldmodel`](../../entities/stable-worldmodel.md) per [the howto](../world-models/leworldmodel-howto.md).
...
- [LeWM-on-Stretch feasibility](../projects/lewm-on-stretch-feasibility.md) — the LeWM-side sketch.
- [DINO-WM-on-Stretch experiment plan](../projects/dino-wm-on-stretch-experiment.md) — the DINO-WM-side sketch.
...
3. **[LeWM hello-world scope](../projects/lewm-hello-world-project-scope.md)** — phase-by-phase plan for A.1.
4. **[LeWM-on-Stretch feasibility](../projects/lewm-on-stretch-feasibility.md)** — hardware-side scoping for A.3 and phase B.
5. **[DINO-WM-on-Stretch experiment plan](../projects/dino-wm-on-stretch-experiment.md)** — the alternative phase-B candidate.
6. **[LeWM howto](../world-models/leworldmodel-howto.md)** — the install / train / eval recipe.
...
- **A reusable phase-A training-run notebook.** The [hello-world scope](../projects/lewm-hello-world-project-scope.md) is prose; an executable notebook reproducing the PushT result would be a useful capstone artifact for future curriculum readers.
