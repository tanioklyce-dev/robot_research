...
>
> Module 12 takes the [LeWM paper](../../sources/leworldmodel-paper.md) section by section, with the **full SIGReg derivation** as the mathematical centerpiece. The point is to be able to read the LeWM paper end to end, evaluate every design choice quantitatively, and reproduce the PushT result yourself ([howto](../world-models/leworldmodel-howto.md), [hello-world scope](../projects/lewm-hello-world-project-scope.md)).
>
...
5. Reproduce the PushT result by following the [howto](../world-models/leworldmodel-howto.md) and [hello-world scope](../projects/lewm-hello-world-project-scope.md), and predict the result on a held-out task using the four-environment patterns in §5.
...
The 48× speedup over DINO-WM ([generative-video vs JEPA synthesis](../world-models/generative-video-vs-jepa-world-models.md), [LeWM paper](../../sources/leworldmodel-paper.md) Fig. 3) decomposes into:
...
Follow the [LeWM howto](../world-models/leworldmodel-howto.md) and the [hello-world scope](../projects/lewm-hello-world-project-scope.md). Concretely:
...
5. **[Generative-video vs JEPA world models](../world-models/generative-video-vs-jepa-world-models.md)** — re-read for the cross-paradigm framing that LeWM lives inside.
6. **[LeWM hello world — Project 1 detailed scope](../projects/lewm-hello-world-project-scope.md)** — the experiment plan to actually run.
