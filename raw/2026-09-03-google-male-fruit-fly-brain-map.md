# Google — The Keyword — "5 amazing visuals show how the male fruit fly's brain map is advancing neuroscience"
# https://blog.google/innovation-and-ai/technology/research/male-fruit-fly-brain-map/
# Published 2026-09-03, by Michał Januszewski and Viren Jain (Research Scientists, Google Research).
# Captured 2026-09-12 by curl + <article>-tag extraction. The five visuals (two images, three videos) are
# lost; their captions survived. The "AI-generated summary" blocks are the page's own and are kept.
# The trailing "Related stories" block is site navigation, not part of the post.
...
[img: Brain map of the male fruit fly https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Male_Fruit_Fly_Hero.width-200.format-webp.webp]
...
Researchers have successfully mapped every neural connection in the adult male fruit fly brain, documenting over 166,000 neurons. By using artificial intelligence to reconstruct these complex pathways, the team created a foundational resource for understanding how sensory input translates into movement and behavior. You can explore the five new visualizations and three companion studies on the Neural Mapping website to see how this work advances our understanding of neuroscience.

 Summaries were generated by Google AI. Generative AI is experimental.

"5 amazing visuals show how the male fruit fly’s brain map is advancing neuroscience" explores brain mapping.

Researchers mapped every neural connection in an adult male fruit fly for the first time.

AI helped scientists reconstruct over 166,000 neurons and nearly 12,000 distinct cell types.

This map reveals key differences in how male and female fly brains process information.

These findings provide a foundational resource for future neuroscience and brain research.

 Summaries were generated by Google AI. Generative AI is experimental.

Scientists just created the first complete map of a male fruit fly’s brain, showing every single connection between its 166,000 neurons. They used AI to stitch together millions of tiny images into a detailed 3D model. This map helps researchers understand how the fly’s brain turns what it sees into movement and social behavior. It’s a huge step forward in learning how brains actually work.
...
[img: Angled brain map of the male fruit fly https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Male_Fruit_Fly_Angled.width-1200.format-webp.webp]
...
[img: Male fruit fly brain map when viewed from above https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Male_Fruit_Fly_Above.width-1200.format-webp.webp]
...
[img: https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Map_Global_Methane_so.2e16d0ba.fill-300x300.format-webp.webp]
...
[img: https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Contrails_Hero.2e16d0ba.fill-300x300.format-webp.webp]
...
[img: https://storage.googleapis.com/gweb-uniblog-publish-prod/images/AskAScientist_Cyclone.2e16d0ba.fill-300x300.format-webp.webp]
...
[img: https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Flood_Thumbnail_001.2e16d0ba.fill-300x300.format-webp.webp]
...
[img: https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Google_blog_image.2e16d0ba.fill-300x300.format-webp.webp]
...
[img: https://storage.googleapis.com/gweb-uniblog-publish-prod/images/AIME_SIZZLE_THUMBNAIL.2e16d0ba.fill-300x300.format-webp.webp]
